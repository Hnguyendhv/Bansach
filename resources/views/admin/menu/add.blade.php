                    ...
                    <div class="form-group">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="active" id="optionsRadios1" value="1" checked=""> hiển thị <i class="input-helper"></i></label>
                      </div>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="active" id="optionsRadios2" value="0" > không <i class="input-helper"></i></label>
                      </div>
